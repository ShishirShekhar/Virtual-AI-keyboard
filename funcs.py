...
# Create a function to add special Keys
def specailKeyButton():
...
def drawAll(img, buttonList, specialKeyList):
...
def run(img):
    ...
    # Get buttons
    buttonList = Nbutton()
    specialKeyList = specailKeyButton()
    # Draw the buttons
    img = drawAll(img=img, buttonList=buttonList, specialKeyList=specialKeyList)
